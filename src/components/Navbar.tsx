...
const Navbar = () => {
  ...
  return (
    <nav className="px-[6%]  py-5 flex justify-between items-center border-b ">
      ...
      <menu
        className={`flex fixed z-50 inset-0 bottom-0 bg-primary bg-opacity-75 backdrop-blur-lg transform  transition-all duration-300 ease-in-out top-20 ${
          open ? " translate-x-0" : " translate-x-full"
        } flex-col  items-center justify-center md:hidden`}
      >
        <ul className="flex flex-col gap-4 text-3xl text-center mb-20">
          ...
          <li>
            <button className="border-black border mt-3 px-6 py-3 rounded-2xl font-semibold">
              Contact Us
            </button>
          </li>
        </ul>
